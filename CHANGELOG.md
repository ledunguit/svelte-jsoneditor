...
* change insert buttons into convert buttons, converting between objects/arrays/text (see [#61](https://github.com/ledunguit/svelte-jsoneditor/issues/61)) ([f413066](https://github.com/ledunguit/svelte-jsoneditor/commit/f413066509b9167af9751218df30922ae5d9ffac))
...
* implement a "Duplicate row" action in the context menu of table mode ([4211a14](https://github.com/ledunguit/svelte-jsoneditor/commit/4211a14ffaa4b64b58ff4ecbbde18e232bf9c48e))
...
* make the option `askToFormat` configurable (fix [#252](https://github.com/ledunguit/svelte-jsoneditor/issues/252)) ([5e5494f](https://github.com/ledunguit/svelte-jsoneditor/commit/5e5494f97da667dc5c8295665dc263b48867f077))
...
* update codemirror, jsonrepair, and other dependencies ([90d1b77](https://github.com/ledunguit/svelte-jsoneditor/commit/90d1b774533b9a2c9716ef580eb0af045974ef56))
...
* [#189](https://github.com/ledunguit/svelte-jsoneditor/issues/189) setup eslint to enforce `.js` file extensions on all imports ([cf37451](https://github.com/ledunguit/svelte-jsoneditor/commit/cf37451e46c56e637924095ab11d6883ade08289))
...
* [#321](https://github.com/ledunguit/svelte-jsoneditor/issues/321) editor not accepting JSON created in a different JavaScript realm like an iframe ([06fb84c](https://github.com/ledunguit/svelte-jsoneditor/commit/06fb84cced17b5b603897e21f30c4c083015190d))
...
* [#96](https://github.com/ledunguit/svelte-jsoneditor/issues/96) add missing properties to `JSONEditorPropsOptional` ([410fd80](https://github.com/ledunguit/svelte-jsoneditor/commit/410fd801297faa46afef201569bfd79792de17e1))
...
* change the row numbering in table mode to zero based for consistency ([d923268](https://github.com/ledunguit/svelte-jsoneditor/commit/d923268b2d550e2779051bb43b08d3daee8f91fe))
...
* disable Search menu item when there is no contents ([e687229](https://github.com/ledunguit/svelte-jsoneditor/commit/e687229a33518356c65850d57a729c2ea6e9637f))
...
* expand contents when pasting in an empty document ([a3c8021](https://github.com/ledunguit/svelte-jsoneditor/commit/a3c80216370dfa176b0eafd6afa9e88a0f9d579f))
...
* improve inefficient regex to replace return characters ([f3ae485](https://github.com/ledunguit/svelte-jsoneditor/commit/f3ae4855004d6c3cc8db88a2c93ebae03d07cacc))
...
* let `createAjvValidator` throw an error when the JSON schema contains an error ([7cfb233](https://github.com/ledunguit/svelte-jsoneditor/commit/7cfb233d92862a34557537cef7840926976b40e1))
...
* onCreateMenu and onCreateContextMenu possibly applying mutated changes without returning ([da8fd60](https://github.com/ledunguit/svelte-jsoneditor/commit/da8fd6093de81daff47847cb1c50992b3f23fdbd))
...
* reset the selection instead of clearing it when the selected contents are removed ([7c937f5](https://github.com/ledunguit/svelte-jsoneditor/commit/7c937f534fd625aca481a22138fc55c9a30b7d5f))
...
* some styling fixes in the Sort modal ([4366a0f](https://github.com/ledunguit/svelte-jsoneditor/commit/4366a0fa1d460def432b3a1900f530c0a63dc2d2))
* sometimes multiple cells selected in Table mode ([c7705f6](https://github.com/ledunguit/svelte-jsoneditor/commit/c7705f6e99e6aba525bc7d17b26dc17add56645c))
* sort/transform the contents of the key instead of the parent when a key is selected ([e761a79](https://github.com/ledunguit/svelte-jsoneditor/commit/e761a79a2a9bc5cf3615bfe49c2f9832c3569c22))
* start typing in an empty document in tree mode throwing an error ([747f2b4](https://github.com/ledunguit/svelte-jsoneditor/commit/747f2b4d78c5c30c0f08ac6fea4823ba6d537be2))
* status bar not visible when caret is at the start of the document ([dca87f0](https://github.com/ledunguit/svelte-jsoneditor/commit/dca87f02800f2b16c311a013581d2ba4db31518f))
* styling fix of the scrollbar in the TransformModal ([5adc31d](https://github.com/ledunguit/svelte-jsoneditor/commit/5adc31d23635e8eac94ffc8c2479adf3cab439ad))
* styling issue with a button text color in dark mode ([4ff40f9](https://github.com/ledunguit/svelte-jsoneditor/commit/4ff40f97d4726a8afbdb736601b866ab5500af61))
* styling issues of the selection dropdown in dark mode ([886330e](https://github.com/ledunguit/svelte-jsoneditor/commit/886330e75879ccdd383a9f324646b96ae9406019))
* styling tweak for the readonly item count tag ([5bbb679](https://github.com/ledunguit/svelte-jsoneditor/commit/5bbb679efccb235a17fafcc82919ea14cb62c66d))
* styling tweaks ([1d15f2b](https://github.com/ledunguit/svelte-jsoneditor/commit/1d15f2b2675922d4c566cdd6cec53caac70dcd7e))
* styling tweaks in the TransformModal ([3983918](https://github.com/ledunguit/svelte-jsoneditor/commit/3983918d125249535211a0228b9444cd6d9bc8f3))
* styling tweaks in the vertical sizing of the TransformModal ([3f87a8a](https://github.com/ledunguit/svelte-jsoneditor/commit/3f87a8ab477d88e155697bc6edc047028da555f7))
* support opening Sort and Transform modals from a JSONEditor modal ([4652c1f](https://github.com/ledunguit/svelte-jsoneditor/commit/4652c1fe3b29b37638a2b2692099b58f49ae84a4))
* support pressing Esc to close the CopyPasteModal ([fb77efe](https://github.com/ledunguit/svelte-jsoneditor/commit/fb77efef5f4a36ae4ff28694e836521fd8170101))
* svelte giving warnings about creating components with unknown properties ([627170a](https://github.com/ledunguit/svelte-jsoneditor/commit/627170a3e621a5ddb0abc1aa016b0a4334bc3837))
* switch from `ajv-dist` to `ajv` again (works ok now with rollup and vite) ([f43a5fb](https://github.com/ledunguit/svelte-jsoneditor/commit/f43a5fb364c161daea507693110d67b96bb19b67))
* table mode broken due to a wrong import (regression since v0.14.6) ([1e48fe5](https://github.com/ledunguit/svelte-jsoneditor/commit/1e48fe50ac2ed613682330e628b1dcfbc224c0c5))
* table mode landing page not handling an empty array correctly ([4b4d039](https://github.com/ledunguit/svelte-jsoneditor/commit/4b4d0398333d59d95d6fd3e28a67038c3b8781ac))
* table row actions not disabled in the table mode context menu when having an empty document ([7123249](https://github.com/ledunguit/svelte-jsoneditor/commit/7123249d28eecae4e9a6875760d63fb47fabbcdd))
* the "Pick" field in the Transform Wizard not restoring the previously selected fields correctly ([635f662](https://github.com/ledunguit/svelte-jsoneditor/commit/635f6624c21a194b5ce96805c9c3a12f1238b234))
* throw an error when a custom Ajv instance provided via `onCreateAjv` is configured wrongly ([78771cd](https://github.com/ledunguit/svelte-jsoneditor/commit/78771cd3a3326bbdb56f400648bafe3c306f6b65))
* throw an error when forgetting to end a Lodash `_.chain(...)` with `.value()` ([f76e4e8](https://github.com/ledunguit/svelte-jsoneditor/commit/f76e4e8bf047680835a34cc5236e3b19d4df9f73))
* tooltip font and size not defined ([a9fa438](https://github.com/ledunguit/svelte-jsoneditor/commit/a9fa4385e001e4162393f2778fbfde9184b1c372))
* transform and sort not triggering a change event ([3b16a21](https://github.com/ledunguit/svelte-jsoneditor/commit/3b16a2158e5d925e3abfa80030858ccb44dacff4))
* truncate text preview of invalid JSON in tree mode ([67f5790](https://github.com/ledunguit/svelte-jsoneditor/commit/67f57908456c9daa89258af095ace61b2fd9f47e))
* tweak font for ubuntu and mac ([b05009c](https://github.com/ledunguit/svelte-jsoneditor/commit/b05009c4b41b200ec8703c85373f55f96138f96f))
* type definition of `JSONEditorPropsOptional.flattenColumns` ([3a28757](https://github.com/ledunguit/svelte-jsoneditor/commit/3a28757a08abc4b1805c1c22e3245fce696ef31c))
* type definition of RenderMenuContext.mode ([51a7133](https://github.com/ledunguit/svelte-jsoneditor/commit/51a7133778f542a5d634165cf7772fee17332647))
* undo/redo buttons in code mode not updated when contents changed externally ([5778540](https://github.com/ledunguit/svelte-jsoneditor/commit/5778540560c3ce6b7d62346e4a9ef302881bc373))
* unnecessary z-index on the context menu pointer ([5a6b2f6](https://github.com/ledunguit/svelte-jsoneditor/commit/5a6b2f65fb5b17e7306cafbf19f1c50003759dae))
* unused CSS selector `".jse-column-header span.jse-column-sort-icon"` ([51c1d54](https://github.com/ledunguit/svelte-jsoneditor/commit/51c1d5441085581402cc916e9479c2c91d5c068e))
* unused CSS selector warnings in Svelte ([23b82cc](https://github.com/ledunguit/svelte-jsoneditor/commit/23b82cc022e15ccbcad6ca4d51ece52ca41682b4))
* update `@codemirror/view` and dev dependencies ([3f2afef](https://github.com/ledunguit/svelte-jsoneditor/commit/3f2afef38bb420bc4f21629ff5cb16e494b6d025))
* update all dependencies ([f083d2c](https://github.com/ledunguit/svelte-jsoneditor/commit/f083d2c1c9570e91b24ee037d1d988c9e733722f))
* update all devDependencies ([13331c7](https://github.com/ledunguit/svelte-jsoneditor/commit/13331c7550a630fa26faa853d04394d6fdaf624a))
* update codemirror and a couple of devDependencies ([7173333](https://github.com/ledunguit/svelte-jsoneditor/commit/71733336b6db16be61b77a4ec4301cff3b7707c7))
* update codemirror dependencies and all devDependencies ([77cbb6d](https://github.com/ledunguit/svelte-jsoneditor/commit/77cbb6d4fc95f3d0867a1117af682d6d534903f8))
* update dependencies ([d9eb233](https://github.com/ledunguit/svelte-jsoneditor/commit/d9eb233c24c958cabd41ad58df372ca6bbb15cf7))
* update dependencies ([4bc6d53](https://github.com/ledunguit/svelte-jsoneditor/commit/4bc6d5356c5f401bf5a0e0ff60a67a046b346e5a))
* update dependencies ([f87572e](https://github.com/ledunguit/svelte-jsoneditor/commit/f87572e2827ec325f3f55318cdd595f762477fbb))
* update dependencies (`codemirror`, `jsonrepair`, `sass`, and others) ([3054f96](https://github.com/ledunguit/svelte-jsoneditor/commit/3054f964c52ddeb44b486dabb1a804c95c5395e7))
* update dependencies (`jsonrepair` and `@codemirror/view`) ([5ff1306](https://github.com/ledunguit/svelte-jsoneditor/commit/5ff130610867d69832722cd3b9b4b9ac40d4e57d))
* update dependencies and dev dependencies ([7229ae6](https://github.com/ledunguit/svelte-jsoneditor/commit/7229ae62d7495614739de4593963707cbdd88e58))
* update dependencies and devDependencies ([0d49b66](https://github.com/ledunguit/svelte-jsoneditor/commit/0d49b66810fa76c4b2fe82021e9dc7b760150407))
* update dependencies and devDependencies ([9275c34](https://github.com/ledunguit/svelte-jsoneditor/commit/9275c3494e4fcf45bd370f9ff77554d9193db4ac))
* update dependencies and devDependencies ([008dcd6](https://github.com/ledunguit/svelte-jsoneditor/commit/008dcd655b8e680cebff7d163daa19b0327c9662))
* update dependencies and devDependencies ([9aa49b6](https://github.com/ledunguit/svelte-jsoneditor/commit/9aa49b6ee63f92712241ab6aa8c6da7987e1b607))
* update dependencies, most notably `codemirror` and `jsonrepair` ([439eb8a](https://github.com/ledunguit/svelte-jsoneditor/commit/439eb8ae8a6a2dfe8fa8ec71f0d5c53e28b7c4a0))
* update dependency `jsonrepair` ([ec23521](https://github.com/ledunguit/svelte-jsoneditor/commit/ec235216a1aee30fd880938dc82233a4731c2f0d))
* update dependency `vanilla-picker` and update devDependencies ([b0ba13f](https://github.com/ledunguit/svelte-jsoneditor/commit/b0ba13fb866aa2565a4bfd135dc8305ef51cf43d))
* update to `lossless-json@2.0.3`, fix throwing an error in case of bad characters like a newline ([7f7b59e](https://github.com/ledunguit/svelte-jsoneditor/commit/7f7b59eac6a965b3c5238f934a4ab4d1b3af152c))
* upgrade `svelte-select` to `4.3.1` ([c92310a](https://github.com/ledunguit/svelte-jsoneditor/commit/c92310a0c3474ac7476056f12b57d1ecf4d9f39c))
* upgrade to jsonrepair@2.2.1, which has some nice improvements ([a34a558](https://github.com/ledunguit/svelte-jsoneditor/commit/a34a55858b292c0a0d47709e3b0cf20992089898))
* upgrade to jsonrepair@3.0.2 and lossless-json@2.0.5 containing an issue with unicode characters ([22cb40e](https://github.com/ledunguit/svelte-jsoneditor/commit/22cb40e6972c3e8a93a3bad8730b6e8e82b374b3))
* upgrade to the latest version of sveltekit and vite, removing the need for viteOptimizeDeps ([c7211a3](https://github.com/ledunguit/svelte-jsoneditor/commit/c7211a30981a453ee0a86ac2594bf0cca3431436))
* use `flex-start` instead of `start` for `align-items` ([#395](https://github.com/ledunguit/svelte-jsoneditor/issues/395)) ([b8be1a5](https://github.com/ledunguit/svelte-jsoneditor/commit/b8be1a57f3a6e35673033e1fbb879997f5533e7c))
* use ajv-dist instead of ajv to solve rollup issues ([a663a1b](https://github.com/ledunguit/svelte-jsoneditor/commit/a663a1bf7748b3332f9e8ddcd12c6c760e953f7f))
* use debug instead of console.log ([b2478b8](https://github.com/ledunguit/svelte-jsoneditor/commit/b2478b86b4382e75400036fab542db17cc874f3e))
* use flex-start and flex-end to fix warnings in environments like tailwindcss ([#43](https://github.com/ledunguit/svelte-jsoneditor/issues/43)) ([e1e0ddd](https://github.com/ledunguit/svelte-jsoneditor/commit/e1e0dddfc6593197bf618a87af94d5a19a8945f9))
* use mono font in JSON Preview ([b07d08d](https://github.com/ledunguit/svelte-jsoneditor/commit/b07d08d9c6bd6a13d797ba1fb51efc6b657e8947))
* validate in code mode not always triggering ([246cf67](https://github.com/ledunguit/svelte-jsoneditor/commit/246cf670259393c56934f0955df31ec957e3f863))
* validation error popup not visible when on the first line ([3a6f0be](https://github.com/ledunguit/svelte-jsoneditor/commit/3a6f0beb2f3cc4d529e740786eaf7fea74ec0955))
* validation errors on an object/array not visible when expanded ([d77ae5b](https://github.com/ledunguit/svelte-jsoneditor/commit/d77ae5bad3ecccc0dd3609d20e89984d7ec14585))
* vertical positioning of expand button when selected was a bit off ([d93e4af](https://github.com/ledunguit/svelte-jsoneditor/commit/d93e4af7bda6607ddc60670f51dccd1e184ed041))
* when inserting a new array or object in an empty editor, set selection inside the array/object ([821933e](https://github.com/ledunguit/svelte-jsoneditor/commit/821933e3dfcbdde637ad78fb6d3c51e5ca6c66ee))
* when inserting a new value by typing somewhere, it doesn't initially have the right color ([9f6ea35](https://github.com/ledunguit/svelte-jsoneditor/commit/9f6ea354270d88c67e3696e7fe8497fbf6852be2))
* when json is changed, clear selection when it refers to a non-existing path ([65c20f0](https://github.com/ledunguit/svelte-jsoneditor/commit/65c20f07014241f41225a178d006577a874dd62f))
* when opening edit mode, sometimes the first typed character was lost ([22b5577](https://github.com/ledunguit/svelte-jsoneditor/commit/22b5577f3432501776b56abdedda5c1854f5d809))
* when pasting, expand all pasted contents by default when small ([ec9703c](https://github.com/ledunguit/svelte-jsoneditor/commit/ec9703c741bf0575864ce699a4c3ea708acdf57a))
* when switching to a different JSON parser, stringify and parse the contents again ([2cece4e](https://github.com/ledunguit/svelte-jsoneditor/commit/2cece4ebc7dbd75dc28f743c5b3ea12470848e7d))
* wrap long lines ([1792525](https://github.com/ledunguit/svelte-jsoneditor/commit/17925255a70dc6ae5a7bdfc58b676aa2377e88b7))
* wrapping line in Copy dropdown menu ([61b10ac](https://github.com/ledunguit/svelte-jsoneditor/commit/61b10ac1d4a50b7d9b7e68b9316adbedd47ffd02))
* write unit tests and fixes for all query languages ([a6af472](https://github.com/ledunguit/svelte-jsoneditor/commit/a6af4728ff6695d872489e4f305dae16ab75a908))
* wrong font in table mode ([dd448c5](https://github.com/ledunguit/svelte-jsoneditor/commit/dd448c5fff9283a4d8d34da9e9afd0ebd9857173))
* z-index issue with the table header ([8f6a7c7](https://github.com/ledunguit/svelte-jsoneditor/commit/8f6a7c77fca5076152841da518a64c5f91652c60))


* make sure the next version will be marked as a breaking change ([0737b6c](https://github.com/ledunguit/svelte-jsoneditor/commit/0737b6c7db31c1421f903a1dc1ef090b358633f1))
